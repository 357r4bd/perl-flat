...
@removed = $re->to_nfa()->to_dfa()->minimize();
ok(($#removed + 1) == 14,
    "DFA_min for 1|001|1(1)1*0|0(101|01000|01010111|11(0011|0)0011)00|1(0110*0)01|0|0(01101|000011|0|1*000)...");
...
@removed = $re->to_nfa()->to_dfa()->minimize();
ok(($#removed + 1) == 7,
    "DFA_min for 1111*1*10(00|0100*01011011|1|110*010|11*000100010*00(1)1*1(0000(1|0|1010)11101|01(000)))...");
